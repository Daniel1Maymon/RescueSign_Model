...
while True:
    ...
    while vid.isOpened():
        ...
        if frame is not None:
            ...
            '''
            encoded_success, encoded_frame = cv2.imencode('.jpg', frame, [cv2.IMWRITE_JPEG_QUALITY, 80])
            count += 1
            ...
            response_from_client, client_addr = server_socket.recvfrom(BUFF_SIZE)
            encoded_frame_from_client, frame_id, model_answer = pickle.loads(response_from_client)
