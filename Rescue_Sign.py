# import os
# print(":: Rescue_Sign.py:: Current working directory: {0}".format(os.getcwd()))
# from os import listdir
# import shutil
# print(" BEFOR:: from ultralytics import YOLO::  ")
# try:
...
#     print(e)
# print(" AFTER:: from ultralytics import YOLO::  ")
...
#             os.chdir(r'C:\Users\project25\Anaconda3\openpose')
#             # Print the current working directory
#             print("Current working directory: {0}".format(os.getcwd()))
